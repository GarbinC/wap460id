...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo ADMIN_IMG_PATH?>favicon.png" type="image/png">

  <title>460id手机站后台管理</title>

  <link href="<?php echo ADMIN_CSS_PATH?>style.default.css" rel="stylesheet">
  <link href="<?php echo ADMIN_CSS_PATH?>jquery.datatables.css" rel="stylesheet">
  <link href="<?php echo ADMIN_CSS_PATH?>bootstrap-fileupload.min.css" rel="stylesheet">
  ...
  <script src="<?php echo ADMIN_JS_PATH?>jquery-ui-1.10.3.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>bootstrap.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>modernizr.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>jquery.sparkline.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>toggles.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>retina.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>jquery.cookies.js"></script>

  <script src="<?php echo ADMIN_JS_PATH?>flot/flot.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>flot/flot.resize.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>morris.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>raphael-2.1.0.min.js"></script>

  <script src="<?php echo ADMIN_JS_PATH?>jquery.datatables.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>chosen.jquery.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>jquery.validate.min.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>ajaxuploadfile.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>custom.js"></script>
  <script src="<?php echo ADMIN_JS_PATH?>dashboard.js"></script>  
...
<section>  
  <div class="leftpanel">
    <div class="logopanel">
        <h1><span>[</span> 460id <span>]</span></h1>
    </div><!-- logopanel -->
    ...
    <div class="leftpanelinner">    
        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">   
            <div class="media userlogged">
                <img alt="" src="<?php echo ADMIN_IMG_PATH?>photos/loggeduser.png" class="media-object">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class=""><a href="<?php echo site_url( 'member/mana');?>"><i class="glyphicon glyphicon-user"></i> <span>会员管理</span></a></li>
        <li class=""><a href="<?php echo site_url( 'category/mana');?>"><i class="glyphicon glyphicon-book"></i> <span>栏目管理</span></a></li>
        <li class=""><a href="<?php echo site_url( 'article/mana');?>"><i class="glyphicon glyphicon-font"></i> <span>文章管理</span></a></li>
        <li class=""><a href="<?php echo site_url( 'adv/mana');?>"><i class="glyphicon glyphicon-star"></i> <span>广告管理</span></a></li>
        <li class="nav-parent"><a href="layouts.html"><i class="fa fa-laptop"></i> <span>系统设置</span></a>
            <ul class="children">
                <li><a href="<?php echo site_url( 'admin/change_pwd');?>"><i class="fa fa-caret-right"></i>密码修改</a></li>
                <li><a href="<?php echo site_url( 'index/logout');?>"><i class="fa fa-caret-right"></i> 安全退出</a></li>
